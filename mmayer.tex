...
\geometry{left=1cm,right=10cm,marginparwidth=6.8cm,marginparsep=1.50cm,top=1.1cm,bottom=0.5cm}
...
\begin{itemize}
\item Functional clone of Amazon's  e-commerce website
\item HTML5, CSS3 and JavaScript
\item Web page: https://sumanthbajjuri07.github.io/Amazon-Clone/
\end{itemize}
